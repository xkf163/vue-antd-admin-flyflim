    ...
    <a-card :body-style="{padding: '24px 32px'}" :bordered="false">
            ...
            <template #extra>
                <a-space class="operator" >
                    ...
                    <a-button @click="submit" type="primary"><a-icon type="vertical-left"  style="margin-right: -6px;" />提交</a-button>
                    <a-button @click="delDoc" type="primary"><a-icon type="save"  style="margin-right: -6px;" />保存</a-button>
                    <a-button @click="addNew" type="danger"><a-icon type="close-circle" style="margin-right: -6px;" />关闭</a-button>
                </a-space>
            </template>
            </a-page-header>
